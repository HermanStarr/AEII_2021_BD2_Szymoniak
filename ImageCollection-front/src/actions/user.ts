import {ApiResponse, PaginatedResult, TagResponse, UserRequest, UserResponse} from "../model/dto";
...
export const getUsers = async (criteria: string): Promise<PaginatedResult<UserResponse>> => {
